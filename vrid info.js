// ==UserScript==
// @name         Vista + Outbound + VRID Info + IB Routes + Late Package Detector
// @namespace    http://tampermonkey.net/
// @version      4.6.11
// @description  CuFt by Dock via API (Vista/Outbound) + VRID Info (Check In / TDR-Dock / Dock / Done / Check Out) + IB/OB Route Distribution
// @author       emanunec
